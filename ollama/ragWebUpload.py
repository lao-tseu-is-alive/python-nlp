...
if __name__ == "__main__":
    print("based on article : https://dev.to/ajmal_hasan/setting-up-ollama-running-deepseek-r1-locally-for-a-powerful-rag-system-4pd4")
    print("run this file with streamlit like this  : streamlit run ollama/ragWebUpload.py")